...
def elaryCheck(path: str, value: str, dataformat: str, timestamp: object, static_attributes: dict):
    ...
    if s == "":
        ...
        __CHECKRESULT__ = timeperoidCheck(__LOCALNEWEST__, timestamp, int(
            static_attributes["timeResolution"]), __CHECKRESULT__)
        __CHECKRESULT__ = timeserialCheck(
            __LOCALNEWEST__, timestamp, __CHECKRESULT__)
